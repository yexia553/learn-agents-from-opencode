...
本仓库已将 OpenCode 源码以 Git submodule 形式引入，方便读者对照教程阅读真实实现。
...
# OpenCode 源码将位于 ./opencode/
cd opencode && bun install
```

> **注意：** 教程中引用的源码路径为 `opencode/packages/opencode/src/...`。
...
├── opencode/                  # OpenCode 源码（submodule）
│   └── packages/
│       └── opencode/
│           └── src/
├── .github/
